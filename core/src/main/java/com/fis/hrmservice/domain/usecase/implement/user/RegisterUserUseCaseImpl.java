...
public class RegisterUserUseCaseImpl {
  ...
  @Autowired private PositionRepositoryPort positionRepositoryPort;
  ...
  @Autowired private AvatarRepositoryPort avatarRepositoryPort;

  @Autowired private CvRepositoryPort cvRepositoryPort;
