...
public class UserValidationService {
    ...
    public void validateCvFile(String contentType, long size) {
        ...
        if (size > CoreConstant.MAX_FILE_SIZE_BYTES) {
            throw new ConflictDataException("cv",
                    String.format("File CV không được vượt quá %dMB", CoreConstant.MAX_FILE_SIZE_MB));
        }
    }
    ...
    public void validateAvatarFile(String contentType, long size) {
        ...
        if (size > CoreConstant.MAX_FILE_SIZE_BYTES) {
            throw new ConflictDataException(String.format("Ảnh đại diện không được vượt quá %dMB", CoreConstant.MAX_FILE_SIZE_MB));
        }
    }
