...
public class LeaveRequestRepositoryAdapter implements LeaveRequestRepositoryPort {
    ...
    public LeaveRequestModel save(LeaveRequestModel model) {
        ...
        LeaveRequest leaveRequest = leaveRequestMapper.toEntity(model);
        LeaveRequest savedEntity = leaveTicketRepository.save(leaveRequest);
        return leaveRequestMapper.toModel(savedEntity);
    }
}